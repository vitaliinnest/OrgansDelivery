...
public static class EnvironmentSetter
{
    ...
    public static void SetEnvironment(User user, Tenant tenant, IServiceProvider serviceProvider)
    {
        SetUser(user, serviceProvider);
        SetTenant(tenant, serviceProvider);
    }
}
